    ...
    private void handleLogin(OutputStream outputStream, String[] tokens) throws IOException {
        ...
        if (tokens.length == 3) {
            ...
            try {
                ...
                //Using ResultSet to check if login and password exists in the database
                ...
                while (rs.next()) {
                    ...
                    if (dbUsername.equals(login) && dbPassword.equals(password)) {
                        x = 1;
                    }
                }
            ...
            //Line for debugging if mysql database is down
