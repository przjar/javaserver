...
public class ChatClient {
    ...
    private void readMsgLoop() {
        //Loop that reads commands and acts accordingly to them
        try {
            String line;
        ...
        //Sending messages using the listeners
        String login;
        String msgBody;
        String groupName;
        if(tokenMsg[1].charAt(0) == '#'){
            ...
            //Use groupMessage function for every listener - similar to what you did with workerList
           ...
           //Use Message function for every listener - similar to what you did with workerList
            //Two lines of code needed
            //
            //
        }
    ...
    private void handleOnline(String[] tokens){
        ...
        //Use online function  for every listener - similar to what you did with workerList
        //Two lines of code needed
        //
        //
    }
    ...
    public void handleOffline(String[] tokens){
        String login = tokens[1];
        //Use offline function  for every listener - similar to what you did with workerList
        //Two lines of code needed
        //
        //
    }
    ...
    public boolean connect(){
        try {
            ...
            //Create client socket, its output and input stream and also buffered reader and write its local port
            //use serverName and serverPort given from LoginWindow
            //
            System.out.println("Client port is " .......);
            //
            //
            //
            return true;
